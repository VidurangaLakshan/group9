...
{{--                                            <h5 class="title" style="{{request()->get('sort') == 'desc' ? 'color: #41bcb8' : ''}} font-size: 18px; font-weight: bold;">Latest</h5>--}}
                                                @if(request()->get('sort') == 'desc')
                                                    <h5 class="title" style="color: #41bcb8; font-size: 18px; font-weight: bold;">Latest</h5>
                                                @else
                                                    <h5 class="title" style="font-size: 18px; font-weight: bold;">Latest</h5>
                                                @endif
                                        </div>
                                    </a>
                                </li>
...
{{--                                            <h5 class="title" style="{{request()->get('sort') == 'asc' ? 'color: #41bcb8' : ''}} font-size: 18px; font-weight: bold;">Oldest</h5>--}}
                                            @if(request()->get('sort') == 'asc')
                                                <h5 class="title" style="color: #41bcb8; font-size: 18px; font-weight: bold;">Oldest</h5>
                                            @else
                                                <h5 class="title" style="font-size: 18px; font-weight: bold;">Oldest</h5>
                                            @endif
                                        </div>
                                    </a>
                                </li>
                        ...
                        <div class="axil-single-widget widget widget_postlist mb--30">
                            <h5 class="widget-title" style="color: black; font-size: 18px; font-weight: bold;">Categories</h5>
                            <!-- Start Post List  -->
                            <div class="axil-single-widget widget widget_categories mb--30" >
                                <ul>
                                    @foreach ($categories as $category)
                                        <li class="cat-item" style="padding: 5px 0px;">
                                            <a href="{{ route('post.index', ['category' => $category->slug]) }}" class="inner" style="justify-content: center; background: #ffffff;">
                                                <div class="content">
                                                    <h5 class="title" style="font-size: 18px; font-weight: bold;">{{$category->title}} ({{($category->posts->count())}})</h5>
...
{{--                        </div>--}}
                        ...
                        <div class="axil-single-widget widget widget_social mb--30">
                            <h5 class="widget-title" style="color: black; font-size: 18px; font-weight: bold;">Stay In Touch</h5>
                            <!-- Start Post List  -->
