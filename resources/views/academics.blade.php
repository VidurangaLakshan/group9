                ...
                <div class="col-lg-12 col-xl-6 col-md-12 col-12">
                    ...
                    <div class="content-block post-grid post-grid-transparent post-overlay-bottom">
                        <div class="post-thumbnail">
                            <a href="">
                                <img src="assets/images/post-images/lifestydfgle-post-01.jpg" alt="Post Images">
                            </a>
                        </div>
                                    ...
                                    <div class="post-cat-list">
                                        <a class="hover-flip-item-wrapper" href="#">
                                                <span class="hover-flip-item">
                                                    <span data-text="AIvolution">AIvolution</span>
                                                </span>
                                        </a>
                                    </div>
                                </div>
                                <h3 class="title"><a href="">Exploring the Impact of Artificial Intelligence on Higher Education</a></h3>
                            </div>
                        </div>
                    </div>
                    <!-- Start Post Grid  -->
                                    ...
                                    <div class="post-content">
                                        <div class="post-cat">
                                            <div class="post-cat-list">
                                                <a class="hover-flip-item-wrapper" href="#">
                                                        <span class="hover-flip-item">
                                                            <span data-text="eLearning Dynamics">eLearning Dynamics</span>
                                                        </span>
                                                </a>
                                            </div>
                                        </div>
                                        <h5 class="title"><a href="">The Evolution of Online Learning: Challenges and Opportunities </a></h5>
                                    </div>
                                </div>
                            </div>
                            <!-- Start Post Grid  -->
                                    ...
                                    <div class="post-content">
                                        <div class="post-cat">
                                            <div class="post-cat-list">
                                                <a class="hover-flip-item-wrapper" href="#">
                                                        <span class="hover-flip-item">
                                                            <span data-text="BlockEd">BlockEd</span>
                                                        </span>
                                                </a>
                                            </div>
                                        </div>
                                        <h5 class="title"><a href="">Understanding Blockchain Technology in Academic Institutions</a></h5>
                                    </div>
                                </div>
                            </div>
                            <!-- Start Post Grid  -->
                                    ...
                                    <div class="post-content">
                                        <div class="post-cat">
                                            <div class="post-cat-list">
                                                <a class="hover-flip-item-wrapper" href="#">
                                                        <span class="hover-flip-item">
                                                            <span data-text="Inclusive Education">Inclusive Education</span>
                                                        </span>
                                                </a>
                                            </div>
                                        </div>
                                        <h5 class="title"><a href="">The Role of Diversity and Inclusion in Modern Classrooms</a></h5>
                                    </div>
                                </div>
                            </div>
                            <!-- Start Post Grid  -->
                                    ...
                                    <div class="post-content">
                                        <div class="post-cat">
                                            <div class="post-cat-list">
                                                <a class="hover-flip-item-wrapper" href="#">
                                                        <span class="hover-flip-item">
                                                            <span data-text="STEMforward">STEMforward</span>
                                                        </span>
                                                </a>
                                            </div>
                                        </div>
                                        <h5 class="title"><a href="">Innovations in STEM Education: Bridging the Skills Gap for Future Careers</a></h5>
                                    </div>
                                </div>
                            </div>
                            <!-- Start Post Grid  -->
                                                    ...
                                                    <div class="post-content">
                                                        <div class="post-cat">
                                                            <div class="post-cat-list">
                                                                <a class="hover-flip-item-wrapper" href="#">
                                                                        <span class="hover-flip-item">
                                                                            <span data-text="VR Learning">VR Learning</span>
                                                                        </span>
                                                                </a>
                                                            </div>
                                                        </div>
                                                        <h4 class="title"><a href="">Emerging Trends in Virtual Reality for Enhanced Learning Experiences</a></h4>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- Start Post Grid  -->
                                                    ...
                                                    <div class="post-content">
                                                        <div class="post-cat">
                                                            <div class="post-cat-list">
                                                                <a class="hover-flip-item-wrapper" href="#">
                                                                        <span class="hover-flip-item">
                                                                            <span data-text="DataScience">DataScience</span>
                                                                        </span>
                                                                </a>
                                                            </div>
                                                        </div>
                                                        <h4 class="title"><a href="">The Rise of Data Science: Transforming Research and Education</a>
                                                        </h4>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="content-block post-grid post-grid-large mt--30">
                                        ...
                                        <div class="post-grid-content">
                                            <div class="post-content">
                                                ...
                                                <h3 class="title"><a href="">Exploring Sustainable Practices in Higher Education: Eco-friendly Initiatives and Impact</a></h3>
                                                <div class="post-meta-wrapper">
                                                    <div class="post-meta">
                                                        <div class="post-author-avatar border-rounded">
                                                            <img src="assets/images/post-images/author/Kaushali-Amaradiwakara.jpg" alt="Author Images">
                                                        </div>
                                                        <div class="content">
                                                            <h6 class="post-author-name">
                                                                <a class="hover-flip-item-wrapper" href="author.html">
                                                                        <span class="hover-flip-item">
                                                                            <span data-text="Kaushali Amaradiwakara">Kaushali Amaradiwakara</span>
                                                                        </span>
                                                                </a>
                                                            </h6>
                                                            <ul class="post-meta-list">
                                            ...
                                            <div class="content-block post-grid mt--30">
                                                ...
                                                <div class="post-grid-content">
                                                    <div class="post-content">
                                                        ...
                                                        <h4 class="title"><a href="">iPadOS 14 new
                                    ...
                                    <div class="content-block post-grid post-grid-large mt--30">
                                        ...
                                        <div class="post-grid-content">
                                            <div class="post-content">
                                                ...
                                                <h3 class="title"><a href="">Eating right is part
    ...
    <div class="axil-post-list-area post-listview-visible-color axil-section-gap bg-color-white">
        <div class="container">
            <div class="row" style="margin-bottom: 40px; margin-top: -50px;">
                <div class="col-lg-12">
                    <div class="section-title">
                        <h2 class="title">Recent Academic Articles</h2>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-8 col-xl-8">
                    ...
                    @foreach($popularPosts as $popularPost)
                        ...
                        @if ($popularPost->getAttribute('approved') == 1 && $popularPost->getAttribute('published_at') <= now() && ($popularPost->author->role->value == 1 || $popularPost->author->role->value == 2 || $popularPost->author->role->value == 3 || $popularPost->author->role->value == 4))
                            ...
                            <div class="post-medium-block">
                                ...
                                @foreach ($oldestPosts as $oldestPost)
                                    @if ($oldestPost->getAttribute('approved') == 1 && $oldestPost->getAttribute('published_at') <= now())
                                        @if ($oldestPost->author->role->value == 1 || $oldestPost->author->role->value == 2 || $oldestPost->author->role->value == 3 || $oldestPost->author->role->value == 4)
                                            <!-- Start Single Post  -->
                                            <div class="content-block post-medium mb--20">
                                                <div class="post-thumbnail">
            ...
            <div class="row">
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 col-md-6 col-12">
                    ...
                    <div class="content-block post-default image-rounded mt--30">
                        <div class="post-thumbnail">
                            <a href="https://web.facebook.com/APIITofficial/videos/357003340468267/">
                                <img src="assets/images/post-images/post-dafdgrk-01.jpg" alt="Post Images">
                            </a>
                            <a class="video-popup position-top-center" href="https://web.facebook.com/APIITofficial/videos/357003340468267/"><span
...
{{--                                                <span data-text="CAREERS">CAREERS</span>--}}
                            ...
                            <h3 class="title"><a href="https://web.facebook.com/APIITofficial/videos/357003340468267/">APIIT Sri Lanka's Video</a></h3>
                            <div class="post-meta-wrapper">
                                <div class="post-meta">
                                    <div class="content">
                                        <h6 class="post-author-name">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="content-block post-default image-rounded mt--30">
                                <div class="post-thumbnail">
                                    ...
                                    <a class="video-popup size-medium position-top-center" href="https://web.facebook.com/APIITofficial/videos/357003340468267/"><span class="play-icon"></span></a>
                                </div>
                                <div class="post-content">
                                    <div class="post-cat">
                                        <div class="post-cat-list">
...
{{--                                                        <span data-text="LIFESTYLE">LIFESTYLE</span>--}}
                                    ...
                                    <h5 class="title"><a href="https://web.facebook.com/APIITofficial/videos/385909257176393/">APIIT Kandy Campus held the Pearson BTEC HND Award Ceremony on the 25th of November 2023 at APIIT Kandy Campus.</a></h5>
                                </div>
                            </div>
                        </div>
                        <!-- End Post List  -->
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="content-block post-default image-rounded mt--30">
                                <div class="post-thumbnail">
                                    <a href="https://web.facebook.com/APIITofficial/videos/385909257176393/">
                                        <img src="assets/images/post-images/post-ddsfark-04.jpg" alt="Post Images">
                                    </a>
                                    <a class="video-popup size-medium position-top-center" href="https://web.facebook.com/APIITofficial/videos/385909257176393/"><span class="play-icon"></span></a>
                                </div>
                                <div class="post-content">
                                    <div class="post-cat">
                                        <div class="post-cat-list">
...
{{--                                                        <span data-text="LEADERSHIP">LEADERSHIP</span>--}}
                                    ...
                                    <h5 class="title"><a href="https://web.facebook.com/APIITofficial/videos/385909257176393/">Cheers to a year filled with knowledge, growth, and endless possibilities! 🎓📚</a></h5>
                                </div>
                            </div>
                        </div>
                        <!-- End Post List  -->
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="content-block post-default  image-rounded mt--30">
                                <div class="post-thumbnail">
                                    <a href="">
                                        <img src="assets/images/post-images/post-dark-03dsf.jpg" alt="Post Images">
                                    </a>
                                    <a class="video-popup size-medium position-top-center" href=""><span class="play-icon"></span></a>
                                </div>
                                <div class="post-content">
                                    <div class="post-cat">
                                        <div class="post-cat-list">
...
{{--                                                        <span data-text="DESIGN">DESIGN</span>--}}
                                    ...
                                    <h5 class="title"><a href="">My Journey.......</a></h5>
                                </div>
                            </div>
                        </div>
                        <!-- End Post List  -->
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12 col-md-6 col-12">
                            ...
                            <div class="content-block post-default image-rounded mt--30">
                                <div class="post-thumbnail">
                                    <a href="https://web.facebook.com/APIITofficial/videos/3670296836528437/">
                                        <img src="assets/images/post-images/post-dark-01.jpg" alt="Post Images">
                                    </a>
                                    <a class="video-popup position-top-center" href="https://web.facebook.com/APIITofficial/videos/3670296836528437/"><span
                                            class="play-icon"></span></a>
                                </div>
                                <div class="post-content">
                                    <div class="post-cat">
...
{{--                                                        <span data-text="DESIGN">DESIGN</span>--}}
                                    ...
                                    <h5 class="title"><a href="https://web.facebook.com/APIITofficial/videos/3670296836528437/">Fitness for higher performance</a></h5>
                                </div>
                                </div>
                            </div>
                            <!-- End Post List  -->
