...
use App\Filament\Editor\Resources\CommentResource\Pages;
use App\Filament\Editor\Resources\CommentResource\RelationManagers;
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('user.name')->searchable()->sortable()->limit(30),
