                    ...
                    Forms\Components\Select::make('mode')
                        ...
                        ->afterStateUpdated(function (string $operation, $state, Forms\Set $set) {
                            if ($state == 2) {
                                ...
                                $set('step5', '5. Wait for the counsellor to reply to the chat');
                            }
                            if ($state == 3) {
                                $set('step1', 'Download MS Teams from the App Store or Google Play Store');
                                $set('step2', 'Sign in with your APIIT email address');
                                $set('step3', 'Search \'sss@apiit.lk\' and open the chat');
                                $set('step4', 'Start the call');
                                $set('step5', 'Wait for the counsellor to join the call');
                            }
...
//
                ...
                Forms\Components\Section::make('How To Call on MS Teams')
                    ...
                    ->schema([
                        ...
                        Forms\Components\TextInput::make('step4')->readOnly()->label('Step 4')
                            ->placeholder('4. Join a call'),

                        Forms\Components\TextInput::make('step5')->readOnly()
                            ->placeholder('5. Wait for the counsellor to join the call'),
