...
use App\Filament\User\Resources\ResumeResource\Pages;
use App\Filament\User\Resources\ResumeResource\RelationManagers;
...
class ResumeResource extends Resource
{
    ...
    public static function getEloquentQuery(): Builder
    {
        return parent::getEloquentQuery()
            // only the resumes that belong to the authenticated user
